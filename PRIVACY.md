...
This MVP is local-only.

- No login.
- No game account ID collection.
...
Before adding ads, analytics, or third-party scripts, update this policy with:

- the provider name,
- the data sent,
- the purpose,
- consent and opt-out behavior,
- regional cookie/tracking requirements.
